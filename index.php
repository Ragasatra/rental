    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <nav class="navbar navbar-expand-lg navbar-light " style="background-color: #e3f2fd;>
                    <a class="navbar-brand" href="#"><?php echo $_SESSION['nama_admin']; ?></a>
        ...
        <div class="row mt-3">
            <div class="col-md-4" > 
                ...
                <ul class="list-group list-group-flush">
                    <?php
                    $cari = mysqli_query($konek, "select * from mobil1 where mobil1.id_admin=$_SESSION[id_admin]");
        ...
        <div class="row mt-3">
            <div class="col-md-12 bg-light">
                <p class="text-center font-weight-bold">Rental-Keun &copy; 2020</p>
            </div>
        </div>
    </div>
